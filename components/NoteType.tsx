...
export type NoteType = 'Assignment' | 'MyDay' | 'Important' | 'Tasks';
...
const NoteTypeDropdown: React.FC<NoteTypeDropdownProps> = ({ selectedNoteType, setSelectedNoteType }) => {
  ...
  return (
    <View style={styles.container}>
      <Picker
        ...
        onValueChange={(itemValue, itemIndex) => handleTypeSwapping(itemValue as string)}>
